...
export const getColourish = (colourString) => {
    const [r, g, b] = splitColour(colourString);
...
const makePattern = (elementStyle) => {
    ...
    const colourish = getColourish(stringColour);
    return getPatternFor[colourish](stringColour) || {};
}
